    ...
    <div className="min-h-screen flex items-center justify-center mx-20">
      <div className="w-full flex ">
        <div className="w-2/3 pr-8">
          ...
          <h3 className="heading2 mb-4 pb-2 border-t pt-7">Second Attendee</h3>
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              <label className="block heading3 mb-1 pb-2 ">First Name</label>
              <input
          ...
          <div className="mb-4">
            ...
            <div className="flex w-6/12 items-center border border-gray rounded-[10px] p-2 bg-white">
              ...
              <input
                type="text"
                className="w-full border-none outline-none border-b"
                placeholder="+66 (555) 000-0000"
              />
            </div>
          </div>
          <h3 className="heading2 mb-4 pb-2 border-t pt-7 ">Third Attendee</h3>
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              <label className="block heading3 mb-1 pb-2 ">First Name</label>
              <input
...
export default ReservationManyPeople;
